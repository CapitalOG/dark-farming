Config = {
    ...
    -- Drying process: wet buds -> dried buds after dryingTime seconds
    dryingSetup = {
        dryingTime = 300, -- Time in seconds to dry wet buds (default: 5 minutes)
        items = {
    ...
    -- Packaging: dried buds -> single bag (1 bud) or bulk bag (bulkAmount buds)
    packagingSetup = {
        bulkAmount = 10,          -- Number of dried buds consumed when making a bulk bag
        singleBaggieCount = 1,    -- Number of plastic baggies consumed per single bag
        bulkBaggieCount = 1,      -- Number of plastic baggies consumed per bulk bag
        baggieItem = 'plastic_baggie', -- Item name for the plastic baggie
        items = {
